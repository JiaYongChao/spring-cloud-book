package com.book.cloud.module.system.api.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.book.cloud.UserController.save(...)")
