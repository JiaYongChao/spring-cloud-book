package com.book.cloud.module.system.controller.admin.logger.vo.operatelog;
...
import com.book.cloud.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.book.cloud.adminserver.UserController.save(...)")
