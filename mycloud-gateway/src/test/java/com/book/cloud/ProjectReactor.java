...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.book.cloud";
    private static final String ARTIFACT_ID = "mycloud";
    private static final String PACKAGE_NAME = "com.book.cloud";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.book.cloud";
        String artifactIdNew = "mycloud";
        String packageNameNew = "com.book.cloud";
        String titleNew = "springcloud管理系统";
        String projectBaseDirNew = "/Users/jiayongchao/person-work/new2/my-spring-cloud"; // 一键改名后，“新”项目所在的目录
