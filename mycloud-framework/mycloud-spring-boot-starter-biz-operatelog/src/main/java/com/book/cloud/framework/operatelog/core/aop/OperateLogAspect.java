package com.book.cloud.framework.operatelog.core.aop;
...
import com.book.cloud.framework.common.util.monitor.TracerUtils;
import com.book.cloud.framework.common.util.servlet.ServletUtils;
import com.book.cloud.framework.operatelog.core.enums.OperateTypeEnum;
import com.book.cloud.framework.operatelog.core.service.OperateLog;
import com.book.cloud.framework.operatelog.core.service.OperateLogFrameworkService;
import com.book.cloud.framework.web.core.util.WebFrameworkUtils;
...
import static com.book.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.book.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.book.cloud.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.book.cloud.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.book.cloud.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.book.cloud.framework.operatelog.core.annotations.OperateLog operateLog,
